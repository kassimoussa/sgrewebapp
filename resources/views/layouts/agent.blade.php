...
<head>
    ...
    <title>SGRE - Agent - @yield('title')</title>
            ...
            <div class="menu-items">
                <ul class="list-unstyled components">
                    <li class="{{ request()->is('agent/dashboard') ? 'active' : '' }}">
                        <a href="{{ route('agent.dashboard') }}" data-bs-toggle="tooltip" data-bs-placement="right"
                ...
                <div class="menu-section">
                    ...
                    <ul class="list-unstyled components">
                        <li class="{{ request()->is('agent/enregistrements*') ? 'active' : '' }}">
                            <a href="{{ route('agent.enregistrements.index') }}" data-bs-toggle="tooltip" data-bs-placement="right"
                                title="La liste des ressortissants">
                                <i class="fas fa-user-plus"></i>
                                <span>Ressortissants</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('agent/employeurs*') ? 'active' : '' }}">
                            <a href="{{ route('agent.employeurs.index') }}" data-bs-toggle="tooltip" data-bs-placement="right"
                                title="La liste des employeurs">
                                <i class="fas fa-users-gear"></i>
                                <span>Employeurs</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('agent/rapports*') ? 'active' : '' }}">
                            <a href="{{ route('agent.rapports.index') }}" data-bs-toggle="tooltip" data-bs-placement="right"
                                title="Rapports">
                ...
                <div class="topbar-right">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <h6 class="dropdown-header">Agent</h6>
                            </li>
                            <li><a class="dropdown-item" href={{ route('agent.profile') }}>Mon profil</a>
                            </li>
